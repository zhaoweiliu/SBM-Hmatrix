...
set(TBB_INTERFACE_VERSION 11101)
...
foreach (_tbb_component ${TBB_FIND_COMPONENTS})
    ...
    get_filename_component(_tbb_release_lib "${CMAKE_CURRENT_LIST_DIR}/../../../lib/lib${_tbb_component}.dylib" ABSOLUTE)

    if (NOT TBB_FIND_RELEASE_ONLY)
        get_filename_component(_tbb_debug_lib "${CMAKE_CURRENT_LIST_DIR}/../../../lib/lib${_tbb_component}_debug.dylib" ABSOLUTE)
    endif()
    ...
    if (EXISTS "${_tbb_release_lib}" OR EXISTS "${_tbb_debug_lib}")
        if (NOT TARGET TBB::${_tbb_component})
            ...
            get_filename_component(_tbb_include_dir "${CMAKE_CURRENT_LIST_DIR}/../../../include" ABSOLUTE)
